...
def main():
    ...
    parser.add_argument('--test_batch-size', type=int, default=4, metavar='N',
                        help='input test batch size for training (default: 64)')
    parser.add_argument('--gtrTracker-batch-size', type=int, default=1000, metavar='N',
    ...
    train_dataset = APP_MATCHER('../data', train=False, download=True)
